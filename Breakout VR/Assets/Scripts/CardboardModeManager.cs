...
public class CardboardModeManager : MonoBehaviour {
	...
	// This is to reset the camera to the current position when switching to VR mode
	...
	public void Start()
	{
		...
		//GM.instance.inputModeButton.gameObject.SetActive (Cardboard.SDK.VRModeEnabled);
	}
